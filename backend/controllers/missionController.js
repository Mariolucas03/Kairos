...
const updateProgress = asyncHandler(async (req, res) => {
    ...
    // ⚠️ Aqui subia "la racha" al completar la ultima diaria. Ya no: la racha
    // es una sola y son los dias seguidos que entras y recoges la recompensa
    // (userController.claimDailyReward). Dos rachas con el mismo nombre se
    // contradecian en pantalla.
