...
const runNightlyMaintenance = async () => {
    ...
    try {
        ...
        // 🔥 El castigo solo aplica a las misiones que TOCABAN ayer:
        //  - las que no tienen días concretos, o las programadas para el día de ayer,
        //  - excluyendo invitaciones coop sin aceptar (nadie puede completarlas),
        //  - y excluyendo las creadas después de que terminara el día evaluado.
        const yesterdayDayNum = yesterday.getDay();
        const startOfToday = new Date(`${getMadridDateString(now)}T00:00:00`);
