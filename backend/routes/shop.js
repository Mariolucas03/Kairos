...
const { getShopItems, createCustomReward, buyItem, useItem, seedShop, exchangeCurrency, getCofres } = require('../controllers/shopController');
const protect = require('../middleware/authMiddleware');
const { protectCron } = require('../middleware/cronMiddleware');

router.get('/', protect, getShopItems);
router.get('/cofres', protect, getCofres);
