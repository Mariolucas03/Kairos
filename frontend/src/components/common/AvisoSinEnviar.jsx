...
export default function AvisoSinEnviar() {
    ...
    return (
        ...
        <div className="fixed left-0 right-0 z-[60] px-4 pointer-events-none" style={{ bottom: '100px' }}>
            <div className="mx-auto w-full max-w-md bg-[#0a0a0c] border border-white/[0.07] rounded-2xl px-3.5 py-2.5 flex items-center gap-3 overflow-hidden relative">
                <div
                ...
                {esperando && (
                    <button
                        ...
                        className="pointer-events-auto shrink-0 w-9 h-9 rounded-xl bg-zinc-900 border border-white/[0.07] text-zinc-300 flex items-center justify-center active:scale-90 transition-transform disabled:opacity-40"
                    >
