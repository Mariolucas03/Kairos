...
// ⚠️ Las CLAVES (dios, rey, guerrero, recluta, esclavo) son las que guarda el
// servidor y no se tocan: cambiarlas seria migrar a todos los clanes. Lo que
// se ve es la etiqueta, y esa si dice lo que es: quien manda, quien ayuda a
// mandar, quien lleva tiempo, quien acaba de llegar.
export const RANK_CONFIG = {
    dios: { label: 'LÍDER', color: 'text-yellow-500 border-yellow-500/50 bg-yellow-500/10', hex: '#eab308', value: 4 },
    rey: { label: 'CAPITÁN', color: 'text-purple-400 border-purple-500/50 bg-purple-500/10', hex: '#a855f7', value: 3 },
    guerrero: { label: 'VETERANO', color: 'text-red-400 border-red-500/50 bg-red-500/10', hex: '#f87171', value: 2 },
    recluta: { label: 'MIEMBRO', color: 'text-blue-400 border-blue-500/50 bg-blue-500/10', hex: '#60a5fa', value: 1 },
    esclavo: { label: 'NOVATO', color: 'text-zinc-500 border-zinc-700 bg-zinc-800/50', hex: '#71717a', value: 0 }
};
